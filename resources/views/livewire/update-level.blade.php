    ...
    <form method="POST" wire:submit.prevent="store">
        ...
        <div class="flex-1">
            <div class="felx-1 mb-5">
                <p class="text-gray-400 text">Lebellé du niveau<span class="text text-red-500">*</span></p>
                <input
            ...
            <div class="flex-1">
                <p class="text-gray-400 text">Code du niveau<span class="text text-red-500">*</span></p>
                <input
                    class="block  rounded-md border-gray-300 w-full
        ...
        <div class="mt-5 flex justify-between items-center">
            ...
            <button type="submit" style="background-color: rgb(29, 83, 201)" class=" p-2 rounded-md text-white text-md">Modifier</button>
        </div>
</div>
</form>
</div>
